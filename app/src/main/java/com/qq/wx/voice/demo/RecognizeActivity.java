...
public class RecognizeActivity extends Activity {
        ...
        mCompleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mRecoState == 0) {
                    ...
                    if (ret < 0) {
                        Toast.makeText(RecognizeActivity.this, "启动语音识别失败",
    ...
    private void initRecognizer() {
        ...
        if (ret < 0) {
            Toast.makeText(RecognizeActivity.this, "初始化语音识别失败",
                    Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    class VRListener implements VoiceRecognizerListener {
        ...
        public void onGetError(int errorCode) {
            // TODO Auto-generated method stub
            if (errorCode == -307) {
                Toast.makeText(RecognizeActivity.this, "5秒没说话自动关闭",
                        Toast.LENGTH_SHORT).show();
                return;
            }

            Toast.makeText(RecognizeActivity.this, String.valueOf(errorCode),
                    Toast.LENGTH_SHORT).show();
        }
